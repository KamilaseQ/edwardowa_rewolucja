...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "29 kwietnia 2025, Politechnika Warszawska. Dokładny budynek i sala — wyślemy do zarejestrowanych uczestników.",
  },
  {
    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          ...
          <h2 className="font-display uppercase text-4xl md:text-5xl tracking-tight mb-6 text-foreground">
            PYTANIA? ODPOWIEDZI.
          </h2>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border border-border/50 rounded-xl px-6 data-[state=open]:bg-card data-[state=open]:border-gradient-start/30 transition-all duration-300 hover:border-gradient-start/20"
                style={{
