  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-2 lg:gap-x-16 lg:gap-y-0 lg:items-center">
          {/* Block A — Heading + paragraphs */}
          <div
            className={`mb-12 lg:mb-0 lg:col-start-1 lg:row-start-1 transition-all duration-700 ${
          ...
          {/* Block B — Chart (mobile: between A and C; desktop: right column spanning both rows) */}
          <div
            className={`mb-12 lg:mb-0 lg:col-start-2 lg:row-start-1 lg:row-span-2 lg:self-center transition-all duration-700 delay-300 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <div className="relative bg-card border border-gradient-start/15 rounded-3xl p-8 md:p-12 overflow-hidden">
              ...
              <div className="relative h-72 mb-8">
                ...
                {/* "You are here" label — mobile (just above the dot, slightly to the right) */}
                <div
                  className={`absolute block md:hidden transition-all duration-500 ${animateChart ? 'opacity-100' : 'opacity-0'}`}
                  style={{ top: '46%', left: '14%', transitionDelay: '1.8s' }}
                >
              ...
              {/* Phase labels */}
              <div className="flex justify-between items-baseline text-[8px] sm:text-xs uppercase tracking-tight sm:tracking-widest gap-1">
                ...
                <span className="text-muted-foreground/40 shrink-0">Wzrost</span>
          ...
          {/* Block C — Mini stats + CTA (mobile: after chart; desktop: below heading in left column) */}
          <div
            className={`lg:col-start-1 lg:row-start-2 transition-all duration-700 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            {/* Mini stats */}
